...
# Existing additive gates move forward with the new schema/action generation.
...
suite = r'''import assert from 'node:assert/strict';
...
print('M8 test migration and adversarial suite applied')
