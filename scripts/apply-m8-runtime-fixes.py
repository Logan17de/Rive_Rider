...
# View Model instance deletion is fail-closed for external live dependencies.
# Lists owned by the instance are lifecycle children and may be removed with it;
# bindings/nested-instance references are not silently cascaded.
patch('src/veyra/dataGraph.js',
