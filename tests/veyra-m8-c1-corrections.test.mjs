...
check('one-way: evaluated output changes while authored target stays byte-identical', [5, 24], () => {
  const store = baseStore(); seedCore(store);
...
check('regression gate: M0-M7 suites remain part of the same npm test discovery surface', [26], () => {
